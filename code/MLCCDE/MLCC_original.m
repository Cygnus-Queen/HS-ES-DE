...
for func = [1:30]
    ...
    fp = fopen(filename,'a+');
   filename2 = strcat(strcat('result','_original.txt'));
    ...
    %fprintf('\n')
    fprintf(fp,'%1.3e %1.3e:', mean(MLCCDE_outcome), std(MLCCDE_outcome));
     fprintf(fp2,'%1.3e %1.3e:', mean(MLCCDE_outcome), std(MLCCDE_outcome));
    for x = 1 : totalTime
